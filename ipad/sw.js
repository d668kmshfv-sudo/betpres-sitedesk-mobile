const CACHE = "betpres-sitedesk-online-1.1.8";
const CACHE_PREFIX = "betpres-sitedesk-online-";
const SHELL = [
  "./", "index.html", "manifest.webmanifest",
  "assets/styles/app.css?v=5.1.8", "assets/styles/appearance-settings.css?v=5.1.0",
  ...
  "assets/js/ipad-bridge.js?v=1.1.8", "assets/js/bootstrap/startup-guard.js?v=5.1.0",
  "assets/js/data/seed-data.js?v=5.1.0", "assets/js/data/material-passport-data.js?v=5.1.0",
  "assets/js/vendor/jszip.min.js", "assets/js/vendor/exceljs.min.js", "assets/js/legacy/sitedesk-core.js?v=5.1.8",
  "assets/js/features/work-spreadsheet.js?v=5.1.0", "assets/js/features/work-statement-roundtrip.js?v=5.1.8",
  "assets/js/features/pdf-preview.js?v=5.1.5", "assets/js/features/timesheet-pdf-export.js?v=5.1.8",
